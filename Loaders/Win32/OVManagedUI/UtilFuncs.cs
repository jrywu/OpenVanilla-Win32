...
namespace OVManagedUI
{
    ...
    public interface IBandSite
    {
        ...
        [PreserveSig] 
        UInt32 AddBand([In, MarshalAs(UnmanagedType.IUnknown)] Object pUnkSite);

        void RemoveBand([In, MarshalAs(UnmanagedType.U8)] UInt32 dwBandID);
        void EnumBands(UInt32 uBand,  out System.IntPtr dwBandID);
    }
    ...
    // Coclass of tryabandservice
    [ComImport, Guid("F60AD0A0-E5E1-45cb-B51A-E15B9F8B2934")]
    class trayBandservice
    {
    }
    // Coclass of OVdeskband
      [ComImport, Guid("6D5D9154-B557-4509-829E-94B8BF962E5B")]
    //{0x6d5d9154, 0xb557, 0x4509, {0x82, 0x9e, 0x94, 0xb8, 0xbf, 0x96, 0x2e, 0x5b}};
    //[ComImport, Guid("C9A6357B-25CC-4bcf-96C1-78736985D412")]
    class OVDeskBand
    {
    }
}
