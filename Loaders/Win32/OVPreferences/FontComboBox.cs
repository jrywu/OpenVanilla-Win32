...
namespace OVPreferences
{
    public class FontComboBox : ComboBox
    {
        ...
        bool both = false;
        int maxwid = 0;
        public string samplestr = " - Hello World";
        Image ttimg;
        ...
        public void setFont(string fontstring)
        {
            ...
            {
                //System.Diagnostics.Debug.WriteLine("iterrate fontface name:"+Items[i].ToString());
                if (ff.IsStyleAvailable(FontStyle.Regular))
                {
                    if (ff.GetName(1033) == fontstring)
                    {
                        SelectedIndex = i;
            ...
            System.Diagnostics.Debug.WriteLine("setfont to index:"+i.ToString());
        }

        public void Populate(String defaultfont, bool b)
        {
            both = b;
            int i = 0;
            foreach (FontFamily ff in FontFamily.Families)
